...
typedoc --name "AncientSouls Documentation" --module commonjs --out ./doc/ --mode file --excludeExternals --externalPattern "**/node_modules/**" --exclude "**/node_modules/**" --disableOutputCheck --ignoreCompilerErrors ./packages
